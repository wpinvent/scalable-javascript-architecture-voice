...
app.register('jira-login', function(sb){
	var template, xbox, target,
		cfg = {
			isLoadData: false, //判断是否已经载入了数据
			name: '', //缓存用户名
			pwd: '' //缓存密码
		};
	
	template = [
		'<div id="xboxJiraLogin" class="xbox-jira-form fn-hide">',
			'<form id="fmJiraLogin" action="/index.php?r=voiceInner/loginJira" method="post">',
				'<div class="xbox-jira-tip">请用域帐号（邮箱前缀）和域密码登录！</div>',
				'<div class="fm-item">',
					'<label for="nameJiraLogin" class="fm-item-label"><span class="fm-required">*</span>用户名：</label>',
					'<input id="nameJiraLogin" class="ui-input" value="" type="text" />',
					'<div class="fm-explain"></div>',
				'</div>',
				'<div class="fm-item">',
					'<label for="pwdJiraLogin" class="fm-item-label"><span class="fm-required">*</span>密码：</label>',
					'<input id="pwdJiraLogin" class="ui-input" value="" type="password" />',
					'<div class="fm-explain"></div>',
				'</div>',
				'<div class="fm-item xbox-jira-save-item">',
					'<input id="saveJiraLogin" class="xbox-jira-save-chk" type="checkbox" value="save" />',
					'<label for="saveJiraLogin" class="xbox-jira-save-lb">保存用户名和密码</label>',
				'</div>',
				'<div class="fm-item">',
					'<span class="ui-round-btn"><input id="submitJiraLogin" type="submit" class="ui-round-btn-text" value="登 录" /></span>',
					'<span class="ui-round-btn"><input id="closeJiraLogin" type="button" class="ui-round-btn-text" value="取 消" /></span>',
				'</div>',
			'</form>',
		'</div>'
	];
			...
			sb.addEvent('closeJiraLogin', 'click', function(){
				...
				if (!(chkWhite(user, txt.user) || chkWhite(pwd, txt.pwd))) {
					...
					app.Ajax.alipay({
						...
						data: {user:user.value, pass:pwd.value}
					});
				}
			});
...
app.register('jira-form', function(sb){
	var cfg, xbox, template, elem, isNeedFeedback,
		stars, album, fm, assign, cache;
		
	template = [
		'<div id="xboxJiraForm" class="xbox-form fn-hide">',
			'<form id="fmJiraForm" action="/index.php?r=voiceInner/createJira" method="post">',
				'<div class="fn-clear">',
					'<div class="fn-left xbox-form-left">',
						'<div class="fm-item">',
							'<label for="pidJira" class="fm-item-label"><span class="fm-required">*</span>项目：</label>',
							'<select id="pidJira" name="pid" class="ui-select xbox-input-half"></select>',
							'<div class="fm-explain"></div>',
						'</div>',
					'</div>',
					'<div class="fn-right xbox-form-right">',
						'<div class="fm-item">',
							'<label for="issueTypeJira" class="fm-item-label"><span class="fm-required">*</span>问题类型：</label>',
							'<select id="issueTypeJira" name="issuetype" class="ui-select xbox-input-half"></select>',
							'<div class="fm-explain"></div>',
						'</div>',
					'</div>',
				'</div>',
				'<div class="fn-clear">',
					'<div class="fn-left xbox-form-left">',
						'<div class="fm-item">',
							'<label for="reporterJira" class="fm-item-label"><span class="fm-required">*</span>报告人：</label>',
							'<input id="reporterJira" name="reporter" class="ui-input xbox-input-half" value="" type="text" />',
							'<div class="fm-explain"></div>',
						'</div>',
					'</div>',
					'<div class="fn-right xbox-form-right">',
						'<div class="fm-item">',
							'<label for="priorityJira" class="fm-item-label"><span class="fm-required">*</span>优先级：</label>',
							'<select id="priorityJira" name="priority" class="ui-select xbox-input-half">',
								'<option value="1">Blocker</option>',
								'<option value="2">Critical</option>',
								'<option value="3" selected="selected">Major</option>',
				...
				'</div>',
				'<div class="fm-item">',
					'<label for="summaryAssignee" class="fm-item-label">开发者：</label>',
					'<div id="assigneeCnt" class="xbox-assign"><img class="xbox-assign-loading" src="/images/ico-loading.gif" alt="loading" /></div>',
				'</div>',
				'<div class="fm-item">',
					'<label for="summaryJira" class="fm-item-label"><span class="fm-required">*</span>概要：</label>',
					'<input id="summaryJira" name="summary" class="ui-input xbox-input-auto" value="" type="text" />',
					'<div class="fm-explain">格式为：作为***，我希望***，以达到***的目的。</div>',
				'</div>',
				'<div class="fm-item">',
					'<label for="descriptionJira" class="fm-item-label"><span class="fm-required">*</span>描述：</label>',
					'<textarea id="descriptionJira" name="description" class="ui-textarea xbox-input-auto"></textarea>',
					'<div class="fm-explain">内容包括：原始需求、关键点、设计方案、改动点、测试关注点。根据自身需要，选择填写。</div>',
				'</div>',
				'<div class="fm-item">',
					'<label class="fm-item-label">附件：</label>',
					'<div id="imagesJira"></div>',
				'</div>',
				'<div class="fm-item">',
					'<label for="feedbackJira" class="fm-item-label"><span class="fm-required">*</span>给用户的反馈：</label>',
					'<textarea id="feedbackJira" name="content" class="ui-textarea xbox-input-auto"></textarea>',
					'<div class="fm-explain"></div>',
				'</div>',
				'<div class="fm-item">',
					'<span class="ui-round-btn"><input id="createJiraForm" type="submit" class="ui-round-btn-text" value="创 建" /></span>',
					'<span class="ui-round-btn"><input id="cancelJiraForm" type="button" class="ui-round-btn-text" value="取 消" /></span>',
				'</div>',
				'<div id="loadingJiraForm" class="fm-item fn-hide">',
					'<img src="/images/ico-loading.gif" class="xbox-form-loading" alt="处理中" />正在向Jira传送需求数据,请稍后…',
				'</div>',
			'</form>',
		'</div>'
	];
	...
	return {
		...
		getImages: function(){
			var html = [], arr,
				url = location.protocol + '//' +  location.host + '/index.php?r=attachment/ViewPicture&id='
		...
		getContent: function(){ //获取建议内容
			var ret,
				cnt = sb.query('.voice-content', elem)[0],
		...
		bindProjects: function(data){ //绑定项目列表
			...
			sb.each(data.schemes, function(item){
				...
				for (j = 0, l = data.types.length; j < l; j++) {
					...
					if (types.indexOf(type.id) > -1) {
						html.push({value: type.id, text: type.name});
					}
				}
				scheme[item.id] = html;
			});
			...
			function changeScheme() {
				...
				app.Ajax.alipay({
					...
					data: {user:cfg.name, pass:cfg.pwd, pid:cache.pid.el.value, issuetype:cache.issueType.el.value}
				});
			}
		...
		bind: function(){ //绑定事件
			...
			cache = {
				pid: {el: sb.get('pidJira'), txt: '请选择项目', required: true},
				issueType: {el: sb.get('issueTypeJira'), txt: '请选择类型', required: true},
				reporter: {el: sb.get('reporterJira'), txt: '报告人不能为空', required: true},
				priority: {el: sb.get('priorityJira'), txt: '请选择优先级', required: true},
				summary: {el: sb.get('summaryJira'), txt: '概要不能为空', required: true},
				description: {el: sb.get('descriptionJira'), txt: '描述不能为空', required: true},
				//assignee: {el: sb.get('assignee'), txt: '', required: false},
				feedback: {el: sb.get('feedbackJira'), txt: '反馈不能为空', required: true}
			};
			...
			sb.addEvent('cancelJiraForm', 'click', function(){
				...
				var target = sb.getTarget(ev), next, parent;
				...
				if (flag) {
					...
					app.Ajax.alipay({
						...
						success: function(res){
							...
							app.Communication.notify({
								type: 'tip-show',
								data:{title:'转化为需求成功', msg:res.msg, cls:'success'}
							});
							//更新建议状态
							app.Communication.notify({
								type: 'voice-state-update',
								data: {state: 'demand', suggestId: sb.attr(elem, 'data-suggestId'), isModify: isNeedFeedback}
							})
						},
						failure: function(res){
							sb.enableButton(btnSubmit);
							...
							app.Communication.notify({
								type: 'tip-show',
								data:{title:'操作失败', msg:res.msg, cls:'error'}
							});
						},
						data: data
					});
	...
	return {
		...
		create: function(data){
			...
			for (i = 0; i < min; i++) {
				...
				html += [
					'<div class="prodissue-left">',
						app.Template.render(data.template, al[i]),
					'</div>',
					'<div class="prodissue-right">'
				].join('');
			...
			if (rows > ar.length) {
				...
				for (l = i + Math.ceil((ar.length - j) / cr); i < l; i++) {
					...
					html += [
						'<div class="prodissue-left">',
							app.Template.render(data.template, ar[j++]),
						'</div>',
						'<div class="prodissue-right">',
							ar[j] ? app.Template.render(data.template, ar[j++]) : '',
						'</div></div>'
					].join('');
				}
...
app.register('suggest-issues', function(sb){
	var template, wrapper, cnt,
		timer, gap,
		classifyCnt = sb.get('issuesWrapper'),
	...
	app.Template.define('prodissue-nav', [//定义渲染模板
		'<dl class="prodissue-dl">',
			'<dt class="prodissue-class">${title}</dt>',
			'<dd class="prodissue-list" data-prod="${id}">',
				'#foreach($issue in $child)',
				'<a href="#" data-problemId="${issue.id}" data-prize="${issue.des}" data-des="${issue.prize}" class="issue prodissue-item">${issue.title}</a>',
				'#end',
			'</dd>',
		'</dl>'
	]);
	...
	return {
		init: function(){
			...
			app.Communication.notify({
				type: 'create-issues',
				data: {template:'prodissue-nav', el:'prodIssue'}
			});
		...
		hide: function(){
			timer = setTimeout(function () {wrapper.style.top = '-1000px';}, 100);
		},
		bind: function(){
			var self = this,
...
app.register('voice-search', function(sb){
	var self, uid,
		...
		data = { //要提交的查询字段
			...
			date_start: '', //开始时间
			date_end: '', //结束时间
			uid: '', //用来标识本人，和stype联合实现我的收藏、我的建议、我的反馈
			stype: '', //myfavorites, myvoice, myfeedback
			page: 1 //页数
		},
		fm = sb.get('fmFilter'),
		alias = {}, //搜索条件别名
	...
	return {
		init: function(){
			...
			app.Template.define('prodissue-filter', [ //定义问题点渲染模板
				'<dl class="prodissue-dl">',
					'<dt class="prodissue-class"><a href="#" data-productId="${id}" class="prodissue-title">${title}</a></dt>',
					'<dd class="prodissue-list">',
						'#foreach($issue in $child)',
						'<a href="#" id="filterIssue${issue.id}" data-problemId="${issue.id}" class="prodissue-item">${issue.title}</a>',
						'#end',
					'</dd>',
				'</dl>'
			]);
			app.Template.define('filter-tags', [ //标签模板
				'<a href="#" class="current" data-tag="">全部</a>',
				'#foreach($tag in $tags)',
				'<a href="#" data-tag="${tag.id}">${tag.name}</a>',
				'#end'
			]);
		...
		bind: function(){
			...
			app.Communication.notify({ //生成问题点
				type: 'create-issues',
				data: {template:'prodissue-filter', el:'filterIssues'}
			});
			app.Communication.notify({ //绑定事件:反馈、忽略、转发等
				type: 'bind-suggest',
				data: {el:suggestHolder}
			});
		...
		getTagsByIssueId: function(id){ //根据问题点获取标签列表
			app.Ajax.alipay({
				...
				success: function(res){
					var html = app.Template.render('filter-tags', {tags: res.data});
					sb.get('filterTag').innerHTML = html;
				},
				failure: function(res){
					app.Communication.notify({
						type: 'tip-show',
						data:{title:'请求标签错误', msg:res.msg, cls:'error'}
					});
				},
				data: {id:id}
			});
		...
		init: function(){
			...
			app.Template.define('suggest-me', [ //外部端
				'<ul class="voice-list">',
					...
					'<li id="suggest${item.suggestId}" class="voice-item" data-suggestId="${item.suggestId}" data-feedback="${item.feedback}">',
						'<div class="avatar-wrapper">',
							'#if(${item.anonymity_img})',
							'<img class="voice-avatar" src="${item.anonymity_img}" />',
							'#else',
							'<img class="voice-avatar" src="https://tfsimg.alipay.com/images/partner/images/partner/T1IVXXXb0bXXXXXXXX" />',
							'#end',
						'</div>',
						'<h4 class="voice-title">${item.title}</h4>',
						'<div class="voice-info">',
							'#if(${item.images})',
							'<span class="voice-annex" title="图片" data-images="${item.images}" data-event="voice-images">图片</span>',
							'#end',
							'<span class="voice-date">${item.date}</span>',
						'</div>',
						'<div class="voice-auth">由 <span class="voice-person">${item.person}</span> 提交到：<span class="voice-prod">${item.problem_name}</span></div>',
						'#macro(ellipsisCnt ${item.content})',
						'<div class="voice-meta">',
							'<span class="state ${item.innerstate}">#macro(showState ${item.innerstate})</span>',
							'#if(${item.feedback} > 0)',
							'<a href="#" data-event="feedback-view">反馈(1)</a>',
							'#end',
						'</div>',
					'</li>',
					'#end',
			...
			app.Template.define('suggest-list', [ //内部端
				'<ul class="voice-list">',
					'#foreach($item in $list)',
					'<li id="suggest${item.suggestId}" class="voice-item" data-productId="${item.product_id}" data-problemId="${item.problem_id}" data-suggestId="${item.suggestId}" data-feedback="${item.feedback}">',
						'<div class="avatar-wrapper">',
							'#if(${item.anonymity_img})',
							'<img class="voice-avatar" src="${item.anonymity_img}" />',
							'#else',
							...
							'<div class="person-wrapper">',
								'<div class="person-bg">',
									...
									'</ul>',
								'</div>',
								'<span class="person-arrow">arrow</span>',
							'</div>',
						'</div>',
						'<h4 class="voice-title"><a href="${item.url}">#macro(ellipsisTitle ${item.title})</a></h4>',
						'<div class="voice-info">',
							'#if(${item.images})',
							'<span class="voice-annex" title="建议包含图片" data-images="${item.images}" data-event="voice-images">图片</span>',
							'#end',
							'<span class="voice-date">${item.date}</span>',
						'</div>',
						'#if(${item.isCollect}>0)',
						'<a href="#" class="voice-favor voice-collected" data-event="voice-favor" title="取消收藏">收藏/取消收藏</a>',
						'#else',
						'<a href="#" class="voice-favor" data-event="voice-favor" title="加入收藏">收藏/取消收藏</a>',
						'#end',
						'<div class="voice-auth">由 <span class="voice-person">${item.person}</span> 提交到：<span class="voice-prod">${item.problem_name}</span></div>',
						'#macro(ellipsisCnt ${item.content})',
						'<div class="voice-meta voice-meta-${item.innerstate}">',
							'<span class="state ${item.innerstate}">#macro(showState ${item.innerstate})</span>',
							'#if(${item.feedback} == 0)',
							'<a href="#" class="feedback" data-event="feedback-view" title="用户将在消息中心收到您的答复">反馈</a>',
							'#else',
							'<a href="#" class="feedback" data-event="feedback-view" title="用户将在消息中心收到您的答复">反馈(1)</a>',
							'#end',
							'<a href="#" class="ignore" data-event="voice-ignore" title="用户将收到系统自动生成的回复">忽略</a>',
							'#if(${item.tags} > 0)',
							'<a href="#" class="tag" data-event="voice-tag" title="为产品的建议进行细分">标签(${item.tags})</a>',
							'#else',
							'<a href="#" class="tag" data-event="voice-tag" title="为产品的建议进行细分">标签</a>',
							'#end',
							'#if(${item.forward} > 0)',
							'<a href="#" class="forward" data-event="voice-forward" data-forward="${item.forward}" title="将建议转到其他地方">转发(${item.forward})</a>',
							'#else',
							'<a href="#" class="forward" data-event="voice-forward" data-forward="0" title="将建议转到其他地方">转发</a>',
							'#end',
							'<a href="#" class="mail fn-hide" data-event="voice-mail" title="通过邮件把建议发送到其他小二">邮件</a>',
							'<a href="#" class="demand" data-event="jira-login" title="把有价值的建议直接转到需求池">需求</a>',
						'</div>',
					'</li>',
					'#end',
				'</ul>'
		...
		post: function(msg){ //post数据
			...
			app.Ajax.alipay({
				...
				failure: function(res){
					app.Communication.notify({
						type: 'tip-show',
						data:{title:'忽略失败', msg:res.msg, cls:'error'}
					});
				},
				data: {voice_id: suggestId}
			});
		},
		success: function(res){
			app.Communication.notify({ //更新建议状态
				type: 'voice-state-update',
				data: {state:'Ignore', suggestId: suggestId}
			});
		}
	};
});
	...
	return {
		init: function(){
			...
			if (globalConfig.pageType !== 'outer') { //内部端
				app.Template.define('feedback-template', [ //反馈页面
					'<div class="feedback-wrapper">',
						'<dl class="feedback-bg">',
							'#if(${feedback})',
							'<dt class="feedback-person">${feedback.feedback_person}：</dt>',
							'<dd>',
								'<div class="feedback-content">${feedback.feedback_content}</div>',
								'<span class="feedback-date">${feedback.feedback_date}</span>',
								'<a href="#" class="feedback-edit" data-event="feedback-edit">编辑</a>',
							'</dd>',
							'<dd class="reply-wrapper fn-hide">',
							'#else',
							'<dd class="reply-wrapper">',
							'#end',
								'<div class="reply-cnt fn-clear">',
									'<div class="reply-swfupload fn-left"><span id="swfUpload${suggestId}"></span></div>',
									'<div class="reply-template fn-left">',
										'#foreach($reply in $replyTemplate)',
										'<a href="#" data-event="template-get" data-index="${velocityCount}" data-replyId="${reply.name}">回复模板[${velocityCount}]<span title="删除" data-event="template-del">X</span></a>',
										'#end',
									'</div>',
								'</div>',
								'<textarea class="reply-content"></textarea>',
								'<div class="fm-explain"></div>',
								'<div id="swfImageHolder${suggestId}" class="images-wrapper"></div>',
								'<div class="reply-action">',
									'<span class="ui-round-btn ui-round-btn-mini"><input type="button" class="ui-round-btn-text" data-event="feedback-add" data-suggestId="${suggestId}" data-feedback="${isFeedback}" value="回 复" /></span>',
									'<a href="#" class="reply-save" data-event="template-add">存为模板</a>',		
								'</div>',
							'</dd>',
						'</dl>',
						'<span class="feedback-arrow">arrow</span>',
					'</div>'
				]);
			} else { //外部端
				app.Template.define('feedback-template', [ //反馈页面
			...
			app.Template.define('reply-template', [ //反馈模板
				'#foreach($reply in $replyTemplate)',
				'<a href="#" data-event="template-get" data-index="${velocityCount}" data-replyId="${reply.name}" seed="reply-template">回复模板[${velocityCount}]<span title="删除" data-event="template-del">X</span></a>',
				'#end'
			]);
		},
		...
		getFeedback: function(){ //请求反馈信息
			app.Ajax.alipay({
				...
				failure: function(res){
					app.Communication.notify({
						type: 'tip-show',
						data:{title:'错误', msg:res.msg, cls:'error'}
					});
				},
				data: {voice_id: cfg.suggestId}
			});
		},
				...
				app.Ajax.alipay({
					...
					success: function(res){
						app.Communication.notify({ //显示反馈信息
							type: 'feedback-refresh',
							data: {
								feedback: res.data, //返回的数据字段名称需要pylu修改
								suggestId: suggestId,
						...
						if (type === 'add') {
							app.Communication.notify({ //更新建议状态
								type: 'voice-state-update',
								data: {state:'save', suggestId: suggestId}
							});
						}
					},
					failure: function(res){
					...
					data: {
						voice_id: suggestId, //建议id
						content: sb.trim(cnt.value), //反馈内容
						attachment_id: '', //反馈图片
						type: type //添加|编辑
					}
				});
	...
	return {
		...
		get: function(msg){ //显示模板内容
			var target = sb.getTarget(msg.ev),
				...
				wrapper = sb.parent(target, '.reply-wrapper'),
				cnt = sb.query('.reply-content', wrapper)[0];
		...
		refreshReply: function(){ //重绘反馈模板
			app.Communication.notify({
				type: 'reply-refresh',
				data: {replyTemplate: data, suggestId: suggestId}
			});
		}
	}
});
...
app.register('voice-images', function(sb){
	...
	return {
		init: function(){
			app.Template.define('album-template', [
				'<div class="photo-wrapper">',
					'<div>',
						'#foreach($img in $album)',
							'#if(${velocityCount} == 1)',
							'<div class="photo-div" data-show="1"><a href="index.php?r=attachment/ViewPicture&id=${img.id}" target="_blank"><img src="index.php?r=attachment/ViewPicture&id=${img.id}" class="photo-big" /></a></div>',
							'#else',
							'<div class="photo-div" style="display:none;" data-show="0"><a href="index.php?r=attachment/ViewPicture&id=${img.id}" target="_blank"><img src="index.php?r=attachment/ViewPicture&id=${img.id}" class="photo-big" /></a></div>',
							'#end',
						'#end',
					'</div>',
					'<ul class="photo-list">',
						'#foreach($img in $album)',
							'#if(${velocityCount} == 1)',
							'<li><a href="javascript:;" class="photo-item"><img src="index.php?r=attachment/ViewPicture&id=${img.id}" class="photo-thumb" data-event="album-wheel" data-index="${velocityCount}" /></a></li>',
							'#else',
							'<li><a href="javascript:;" class="photo-item"><img src="index.php?r=attachment/ViewPicture&id=${img.id}" class="photo-thumb" data-event="album-wheel" data-index="${velocityCount}" /></a></li>',
							'#end',
						'#end',
		...
		handle: function(msg){ //初始化图片显示
			...
			if (album) {
				...
				html = app.Template.render('album-template', {album: imgs});
				if (rel) {
...
app.register('voice-forward', function(sb){
	var template, xbox, cfg,
		issues;
	
	template = [
		'<div id="xboxTransmit" class="xbox-transmit fn-hide">',
			'<div id="issuesListTransmit"></div>',
		'</div>'
	];
	app.Template.define('forward-template', [//xbox问题点模板
		'<dl class="prodissue-dl">',
			'<dt class="prodissue-class">${title}</dt>',
			'<dd class="prodissue-list" data-prodId="${id}">',
				'#foreach($issue in $child)',
				'<a href="#" data-issueId="${issue.id}" class="prodissue-item">${issue.title}</a>',
				'#end',
			'</dd>',
		'</dl>'
	]);
	...
	return {
		init: function(){
			...
			app.Communication.notify({
				type: 'create-issues',
				data: {template:'forward-template', el:issues}
			});
	...
	return {
		init: function(){
			...
			app.Template.define('tags-template', [ //标签模板
				'#if(${voice_tag}.length > 0)',
				'<dt class="tags-dt">建议已有标签</dt>',
				'<dd class="tags-dd">',
					'#foreach($tag in $voice_tag)',
					'<a href="#">${tag.name}<span data-tagId="${tag.id}" data-event="tags-del" title="删除标签">X</span></a>',
					'#end',
				'</dd>',
				'#end',
				'<dt class="tags-explain">多个标签请用英文逗号隔开，每条建议最多可添加5个标签</dt>',
				'<dd class="tags-txt">',
					'<textarea id="txtTags" class="tags-cnt"></textarea>',
					'<div id="tagsError" class="fm-explain"></div>',
				'</dd>',
				'#if(${issue_tag}.length > 0)',
				'<dt class="tags-dt">问题点常用标签</dt>',
				'<dd class="tags-dd">',
					'#foreach($tag in $issue_tag)',
					'<a href="#" data-event="tags-set">${tag.name}</a>',
					'#end',
				'</dd>',
				'#end'
			]);
		...
		delTags: function(el){ //删除标签
			if (!isLocked) {
				...
				app.Ajax.alipay({
					...
					data: {voice_id:cfg.suggestId, tag_id:sb.attr(el, 'data-tagId')}
				});
			}
		},
		addTags: function(){
			...
			app.Ajax.alipay({
				...
				data: {
					product_id: cfg.productId, //产品线
					problem_id: cfg.problemId, //问题点
					voice_id: cfg.suggestId, //建议id
					tags: txt
				}
			});
		},
		handle: function(msg){
			...
			app.Ajax.alipay({
				...
				data: {problem_id:cfg.problemId, voice_id:cfg.suggestId}
			});
		},
...
app.register('issues-subscribe', function(sb){
	var self, xbox, issueListCnt,
		isLocked = false, //防止重复提交
		totalPage, oldPage = 1,
		pages = {},
		suggestHolder, pageHolder,
		subscribeHolder,
		data = {
			keyid: '', //默认请求全部已订阅问题点
			page: 1
	...
	app.Template.define('issues-list', [//xbox问题点模板
		'<dl class="prodissue-dl">',
			...
			'<dd class="prodissue-list">',
				...
				'<label class="prodissue-lb" for="issue-${item.id}" title="${item.title}"><input id="issue-${item.id}" type="checkbox" class="prodissue-chk" value="${item.id}" />${item.title}</label>',
				'#end',
			'</dd>',
		'</dl>'
	]);
	...
	return {
		init: function(){
			var template = [
				'<div id="xboxSubscribe" class="subscribe-xbox fn-hide">',
					'<div id="issueListCnt"></div>',
					'<div class="subscribe-action">',
						'<span class="ui-round-btn"><input id="btnAddIssueOk" type="button" class="ui-round-btn-text" value="确 定" /></span>',
						'<span class="ui-round-btn"><input id="btnAddIssueCancel" type="button" class="ui-round-btn-text" value="取 消" /></span>',
					'</div>',
				'</div>'
				];
			document.body.appendChild(sb.create(template.join('')));
		...
		bind: function(){
			app.Communication.notify({
				type: 'create-issues',
				data: {template:'issues-list', el:issueListCnt}
			});
			app.Communication.notify({ //绑定事件:反馈、忽略、转发等
				type: 'bind-suggest',
				data: {el:suggestHolder}
		...
		getData: function(){
			...
			sb.each(sb.query('input', issueListCnt), function(input){
				if (input.checked) {
					d.push({id:input.value, value:input.parentNode.title});
				}
			});
			return d;
		},
...
app.register('key-subscribe', function(sb){
	var self,
		...
		totalPage, oldPage = 1,
		pages = {},
		suggestHolder, pageHolder, keyHolder,
		data = {
			keyid: '', //默认请求全部已订阅关键字
			page: 1
		};
		...
		addKey: function(name){ //添加关键字
			if (!isLocked) {
				...
				app.Ajax.alipay({
					...
					data: {keyName: name, stype: 1} //stype 标识添加关键字，添加问题点
				});
			}			
		},
		delKey: function(el){ //删除关键字
			if (!isLocked) {
				...
				app.Ajax.alipay({
					...
					data: {kid: sb.attr(el, 'data-keyId')}
				});
			}
		},
		setKeyId: function(v){
...
app.register('alipay-login', function(sb){
	...
	return {
		init: function(){
			...
			//app.Tab({id: 'loginTab'});
			//this.bind();
			xbox = sb.domBox({width:450, id:'xboxLogin', title:'登录支付宝'});
			//xbox.hide();
			app.Communication.listen({
				type: 'alipay-login',
				context: this,
					...
					app.Ajax.alipay({
						...
						failure: function(res){
							...
							if(res.msg == 'wrongcode'){
								...
								app.Communication.notify({
									type: 'tip-show',
									data: {title:'登录失败', msg:res.msg}
								});
							}
						},
						data:{name:nick.value, link:contact.value, code:valid.value}
					});
				}	
			});
		},
...
app.register('tip-alert', function(sb){
	...
	template = [
		'<div class="tip-interact" id="tipInteract">',
			'<span class="ico"></span>',
			'<h3 class="title" id="tipInteractTitle"></h3>',
			'<div class="msg" id="tipInteractMsg"></div>',
			'<div class="action">',
				'<span class="custom-btn"><input type="button" value="我知道了" class="custom-btn-text" id="btnInteractClose"></span>',
			'</div>',
		'</div>'
	];
	...
	return {
		init: function(){
			document.body.appendChild(sb.create(template.join('')));
			this.bind();
			xbox = sb.domBox({width:450, id:'tipInteract', title:'提示信息', beforeHide: this.beforeHide});
			app.Communication.listen({
				type: 'tip-show',
				context: this,
				callback: this.show
...
app.register('post-suggest', function(sb){
	var self, flag, swu, xbox,
		refurl = sb.get('refurl').value,
		idle = true, //防止重复提交
		pageType = globalConfig.pageType, //判断内部端还是外部端
		isInner = pageType !== 'outer', //内部端标识
	...
	return {
		...
		createXbox: function(){ //内部端生成xbox
			var template = [
					'<div id="xboxPublish" class="publish-wrapper fn-hide">',
						'<div class="publish-item">',
							'<input id="envelopeTitle" type="text" class="ui-input" placeholder="建议标题" />',
							'<div class="fm-explain"></div>',
						'</div>',
						'<div class="publish-item">',
							'<select id="envelopeTypeProd" class="ui-select"></select>',
							'<select id="envelopeType" class="ui-select"></select>',
							'<div class="fm-explain"></div>',
						'</div>',
						'<div class="publish-item">',
							'<textarea id="envelopeCnt" class="ui-textarea" placeholder="建议内容"></textarea>',
							'<div class="fm-explain"></div>',
						'</div>',
						'<div class="publish-item">',
							'<div id="imagesWrapper"></div>',
						'</div>',
						'<div class="publish-item publish-action">',
							'<span class="custom-btn"><input id="postSuggest" type="button" seed="sound-submit" class="custom-btn-text" value="提 交" /></span>',
						'</div>',
					'</div>'
				];
		...
		publish: function(){ //发建议
			var imgs;
				...
				if(flag && idle){ //提交数据
					...
					self.disableSubmit();
					app.Ajax.alipay({
						url: isInner ? 'index.php?r=voiceInner/add' : 'index.php?r=voice/add', //外部端url，内部端voiceInner/add
						success: self.success,
						failure: self.failure,
						data: {
		...
		success: function(res){ //发表成功
			if (pageType === 'inner') { //内部端
				this.success = function(res){
					...
					app.Communication.notify({
						type: 'tip-show',
						data:{title:'发表成功', msg:res.msg, cls:'success'}
					});
				}
			} else { //外部端
				this.success = function(res){
		...
		failure: function(res){ //发表失败
			...
			if (res.msg === 'nologin') {//未登录
				...
				app.Communication.notify({
					type: 'tip-show',
					data:{title:'发表失败', msg:res.msg, cls:'error'}
				});
			}
		},
		selectIssue: function(){ //显示已经问题点的描述
			var el,
				params = sb.getParams(location.search);
...
app.register('issue-grade', function(sb){
	var self, data = {}, postCnt, gradeCnt, gradePoint;
	...
	return {
		init: function(){
			...
			app.Template.define('option-template', [ //选项模板
				'#foreach($opt in $problems)',
				'<li class="problem-item"><input id="optProblem${velocityCount}" class="problem-chk" type="checkbox" value="${opt.id}" /><label for="optProblem${velocityCount}" class="problem-lb">${opt.option_name}</label></li>',
				'#end'
			]);
			app.Communication.listen({
				type: 'grade-show',
	...
	return {
		init: function(){
			...
			app.Template.define('pandect-template', [ //建议总览模板
				'<div class="title-bar">' + period + ' 建议总览</div>',
				'<ul id="pandectStat">',
					'<li><strong>建议量</strong><span>${total}</span></li>',
					'<li><strong>已忽略</strong><span>${ignore}</span></li>',
					'<li><strong>已反馈</strong><span>${save}</span></li>',
					'<li><strong>未处理</strong><span>${untreated}</span></li>',
					'<li><strong>转需求</strong><span>${demand}</span></li>',
				'</ul>'
			]);
			app.Template.define('satisfy-template', [ //排行模板
				'#foreach($item in $topicSatisfy)',
				'<li><a href="index.php?r=statistic/score&productName=${item.productName}&problemName=${item.problemName}&datestart=${item.startDate}&dateend=${item.endDate}">${item.problemName}</a><span>${item.point}</span></li>',
				'#end'
			]);
			app.Template.define('topic-template', [
				'#foreach($item in $topicProblem)',
				'<li><a href="index.php?r=statistic/option&productName=${item.productName}&problemName=${item.problemName}&datestart=${item.startDate}&dateend=${item.endDate}">${item.name}</a></li>',
				'#end'
			]);
			...
			app.Template.define('prodissue-template', [ //定义问题点渲染模板
				'<dl class="prodissue-dl">',
					...
					'<dd class="prodissue-list">',
						'#foreach($issue in $child)',
						'<a href="#" data-problemId="${issue.id}" class="prodissue-item">${issue.title}</a>',
						'#end',
					'</dd>',
				'</dl>'
			]);
			app.Communication.notify({ //生成问题点
				type: 'create-issues',
				data: {template:'prodissue-template', el:'queryIssues'}
			});
		...
		bind: function(){
			var selectedState = sb.query('#queryState .current')[0], //建议状态选中项
...
app.register('new-online', function(sb){
	var self, ul, distance = 890, timer, second = 6;
...
app.register('statistics-operate', function(sb){
	...
	return {
		...
		format: function(){ //格式化数据
			var ret = [], a, arr = sb.query('#tblDetail .result');
